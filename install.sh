...
clear
echo -e " ${LRED}####################################${NC}"
echo -e " ${LRED}#${NC}  ${GREEN}Installing CoresUpdater v.6.66beta${NC}${LRED}#${NC}"
echo -e " ${LRED}####################################${NC}\n"
...
if [ "$EUID" -ne 0 ]
  then echo "I am not root, perfect!"
  else (echo "I am root, changing permissions to the files"
